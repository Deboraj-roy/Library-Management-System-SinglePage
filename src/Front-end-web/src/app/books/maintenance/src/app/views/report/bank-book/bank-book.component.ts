...
public type:any;
  ...
  getFirstStatement(){
    ...
    this.strt="rakib";
    let type='Bank';
    this._noteService.getBankAndCashBookList(this.startDate,this.endDate,type, this.selectedBankId).subscribe((res:any)=>{
  ...
  getReport(){
    this._noteService.getBankAndCashBookReport(this.type,this.startDate,this.endDate,"Bank",this.selectedBankId).subscribe((res:any)=>{

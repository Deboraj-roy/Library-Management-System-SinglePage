...
public type:any;
  ...
  getAllTransactions(ledgerId: number, subLedgerId: number){
    let type='Cash';
    this._noteService.getAllTransactions(this.startDate,this.endDate,type, 0, ledgerId, subLedgerId).subscribe((res:any)=>{
  ...
  getFirstStatement(){
    ...
    this.strt="shajol";
    let type='Cash';
    this._noteService.getBankAndCashBookListDatewise(this.startDate,this.endDate,type, 0).subscribe((res:any)=>{
  ...
  getReport(){
    this._noteService.getBankAndCashBookReportDatewise(this.type,this.startDate,this.endDate,"Cash", 0).subscribe((res:any)=>{

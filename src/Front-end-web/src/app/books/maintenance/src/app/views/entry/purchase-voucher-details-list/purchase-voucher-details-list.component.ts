...
@Component({
  selector: 'app-purchase-voucher-details-list',
  templateUrl: './purchase-voucher-details-list.component.html',
  styleUrls: ['./purchase-voucher-details-list.component.scss']
})
export class PurchaseVoucherDetailsListComponent {
...
constructor(
  ...
  getLedgerByVoucher(){
    ...
    this._entryService.getVoucherDetails("PurchaseVoucher",this.startdatePipeString,this.enddatePipeString,this.ledgerId).subscribe((res:any)=>{
    ...
    for(i;i<this.listOfLedger.length;i++){
      ...
      this.totalamount=this.totalamount+ this.listOfLedger[i].credit;

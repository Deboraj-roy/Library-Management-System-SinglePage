...
export class SalesVoucherListComponent {
...
constructor(
  ...
  getLedgerByVoucher(){
    debugger;
    this.listOfLedger[0];
    this._entryService.getLedgerByVoucher("SalesVoucher",this.startdatePipeString,this.enddatePipeString).subscribe((res:any)=>{

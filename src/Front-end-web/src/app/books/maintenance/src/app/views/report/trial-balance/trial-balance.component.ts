...
export class TrialBalanceComponent {
  ...
  getTrailBalance(start:any, end:any){
    this.title=true;
      ...
      {
        this.tempDebit = this.trialBalance[i].openingDebit > this.trialBalance[i].openingCredit ? (this.trialBalance[i].openingDebit - this.trialBalance[i].openingCredit) : 0.00;
        this.tOpDbt= new BigNumber(this.tOpDbt);
        this.tOpDbt2= new BigNumber(this.tempDebit);
        this.tOpDbt3=this.tOpDbt.plus(this.tOpDbt2);
        this.tOpDbt=this.tOpDbt3;

        this.trialBalance[i].openingCredit = this.trialBalance[i].openingCredit > this.trialBalance[i].openingDebit ? (this.trialBalance[i].openingCredit - this.trialBalance[i].openingDebit) : 0.00;
        this.trialBalance[i].openingDebit = this.tempDebit;
        ...
        this.tempDebit = this.trialBalance[i].currentDebit > this.trialBalance[i].currentCredit ? (this.trialBalance[i].currentDebit - this.trialBalance[i].currentCredit) : 0.00;
        this.tCurrDbt= new BigNumber(this.tCurrDbt);
        this.tCurrDbt2= new BigNumber(this.tempDebit);
        this.tCurrDbt3=this.tCurrDbt.plus(this.tCurrDbt2);
        this.tCurrDbt=this.tCurrDbt3;

        this.trialBalance[i].currentCredit = this.trialBalance[i].currentCredit > this.trialBalance[i].currentDebit ? (this.trialBalance[i].currentCredit - this.trialBalance[i].currentDebit) : 0.00;
        this.trialBalance[i].currentDebit = this.tempDebit;
        ...
        this.tempDebit = this.trialBalance[i].closingDebit > this.trialBalance[i].closingCredit ? (this.trialBalance[i].closingDebit - this.trialBalance[i].closingCredit) : 0.00;
        this.tCloDbt= new BigNumber(this.tCloDbt);
        this.tCloDbt2= new BigNumber(this.tempDebit);
        this.tCloDbt3=this.tCloDbt.plus(this.tCloDbt2);
        this.tCloDbt=this.tCloDbt3;

        this.trialBalance[i].closingCredit = this.trialBalance[i].closingCredit > this.trialBalance[i].closingDebit ? (this.trialBalance[i].closingCredit - this.trialBalance[i].closingDebit) : 0.00;
        this.trialBalance[i].closingDebit = this.tempDebit;
  ...
  invoicegnrt(start:any, end:any){
    this.download=true;
    this._noteService.getReport(start,end).subscribe(res=>{

...
public type:any;
  ...
  getFirstStatement(){
    ...
    this.strt="rakib";
    let type='Cash';
    this._noteService.getBankAndCashBookList(this.startDate,this.endDate,type, 0).subscribe((res:any)=>{
  ...
  getReport(){
    this._noteService.getBankAndCashBookReport(this.type,this.startDate,this.endDate,"Cash", 0).subscribe((res:any)=>{

...
namespace LMS_API.Migrations
{
    ...
    [Migration("20241002045906_initialMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS_API.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS_API.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS_API.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS_API.Entities.Book", b =>
                {
                    b.HasOne("LMS_API.Entities.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("LMS_API.Entities.Order", b =>
                {
                    b.HasOne("LMS_API.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LMS_API.Entities.User", "User")
                        .WithMany()
